...
import SoundTutorial from "../../../../assets/videos/SoundTutorial2.mp4";  // ← your tutorial video path
...
function AnimalsLessonActivity1() {
  ...
  return (
    <>
      ...
      {/* Main Game Screen */}
      {!showTutorial && (
        <div className="flex h-[100vh] w-[100vw] font-[coiny] overflow-hidden bg-cover bg-no-repeat"
